    ...
    return (
        <Body className="Body">
            <Container>
                <Header>
                    <IconContainer>
                        <Icon src={require("../../../Icons/padlock.png")} />
                    </IconContainer>
                    <H2>Sign Up</H2>
                </Header>
                <Main>
                    <Form>
                        ...
                        <CheckboxContainer>
                            ...
                            <PrimaryText>I want to recive inspiration, marketing promotions and updates via email</PrimaryText>
                        </CheckboxContainer>
                ...
                <Footer>
                    <SecondaryText>Copyright © Your Website 2022.</SecondaryText>
                </Footer>
            </Container>
        </Body>
    );
